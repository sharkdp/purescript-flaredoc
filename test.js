...
(function(exports) {
  ...
  var render = function (output) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Sparkle line 488, column 1 - line 490, column 34: " + [ output.constructor.name, v.constructor.name ]);
      };
  };
      ...
      return new Flammable((function () {
          ...
          var toMaybe = function (v) {
              return function (v1) {
                  ...
                  throw new Error("Failed pattern match at Sparkle line 119, column 11 - line 119, column 35: " + [ v.constructor.name, v1.constructor.name ]);
              };
          };
          var isJust = function (v) {
              ...
              throw new Error("Failed pattern match at Sparkle line 121, column 11 - line 121, column 33: " + [ v.constructor.name ]);
          };
          var $$default = function (v) {
              ...
              throw new Error("Failed pattern match at Sparkle line 123, column 11 - line 123, column 31: " + [ v.constructor.name ]);
          };
  ...
  var prettyPrec = function (d) {
      return function (v) {
          if (v instanceof Data_Generic.SProd) {
              var showParen = function (v1) {
                  return function (x) {
                      ...
                      throw new Error("Failed pattern match at Sparkle line 307, column 9 - line 307, column 30: " + [ v1.constructor.name, x.constructor.name ]);
                  };
              };
          ...
          throw new Error("Failed pattern match at Sparkle line 297, column 1 - line 297, column 50: " + [ d.constructor.name, v.constructor.name ]);
      };
  };
  ...
  var interactiveBoolean = new Interactive((function () {
      var classN = function (v) {
          ...
          throw new Error("Failed pattern match at Sparkle line 364, column 7 - line 365, column 7: " + [ v.constructor.name ]);
      };
      var markup = function (v) {
  ...
  exports["prettyPrintRowList"] = prettyPrintRowList;
  exports["spark"] = spark;
  exports["sparkleDoc'"] = sparkleDoc$prime;
  ...
  var inlines = function (dictValue) {
      ...
      var autolink = (function () {
          var autoLabel = function (s) {
              ...
              throw new Error("Failed pattern match at Text.Markdown.SlamDown.Parser.Inline line 237, column 5 - line 237, column 32: " + [ s.constructor.name ]);
          };
...
(function(exports) {
  ...
  var setextLevel = function (s) {
      ...
      throw new Error("Failed pattern match at Text.Markdown.SlamDown.Parser line 98, column 1 - line 98, column 27: " + [ s.constructor.name ]);
  };
  ...
  var removeNonIndentingSpaces = function (s) {
      ...
      throw new Error("Failed pattern match at Text.Markdown.SlamDown.Parser line 57, column 1 - line 57, column 43: " + [ s.constructor.name ]);
  };
  ...
  var listItemType = function (s) {
      ...
      throw new Error("Failed pattern match at Text.Markdown.SlamDown.Parser line 145, column 1 - line 145, column 36: " + [ s.constructor.name ]);
  };
  ...
  var listItemIndent = function (s) {
      ...
      throw new Error("Failed pattern match at Text.Markdown.SlamDown.Parser line 152, column 1 - line 152, column 30: " + [ s.constructor.name ]);
  };
  ...
  var parseContainers = function (acc) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Text.Markdown.SlamDown.Parser line 254, column 1 - line 258, column 25: " + [ acc.constructor.name, v.constructor.name ]);
      };
  };
      ...
      return function (v) {
          var inline = function (v1) {
              ...
              return __unused(dictPartial)((function () {
                  ...
                  throw new Error("Failed pattern match at Test.FlareDoc line 113, column 5 - line 113, column 43: " + [ v1.constructor.name ]);
              })());
          };
          var block = function (v1) {
              ...
              return __unused(dictPartial)((function () {
                  ...
                  if (v1 instanceof Text_Markdown_SlamDown_Syntax_Block.Lst) {
                      return "<ul><li>" + (Data_Foldable.intercalate(Data_List_Types.foldableList)(Data_Monoid.monoidString)("</li><li>")(Data_Functor.map(Data_List_Types.functorList)(Data_Foldable.foldMap(Data_List_Types.foldableList)(Data_Monoid.monoidString)(block))(v1.value1)) + "</ul>");
                  };
                  throw new Error("Failed pattern match at Test.FlareDoc line 108, column 5 - line 108, column 41: " + [ v1.constructor.name ]);
              })());
          };
              ...
              return function (moduleName) {
                  return function (functionName) {
                      return function (x) {
                          ...
                          return Sparkle["sparkleDoc'"](dictInteractive)(parentId)(functionName)(docString)(x);
                      };
                  };
              };
          };
...
(function(exports) {
  ...
  var main = Test_FlareDoc.withPackage("purescript-arrays.json")(function (dict) {
      ...
      return function __do() {
          doc(Sparkle.interactiveFunction(Sparkle.flammableInt)(Sparkle.interactiveFunction(Sparkle.flammableInt)(Sparkle.interactiveArray(Data_Generic.genericInt))))("range")(Data_Array.range)();
          doc(Sparkle.interactiveFunction(Sparkle.flammableInt)(Sparkle.interactiveFunction(Sparkle.flammableString)(Sparkle.interactiveArray(Data_Generic.genericString))))("replicate")(Data_Array.replicate)();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveArray(Data_Generic.genericNonEmpty(Data_Generic.genericArray(Data_Generic.genericInt))(Data_Generic.genericInt))))("group")(Data_Array.group(Data_Eq.eqInt))();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveArray(Data_Generic.genericNonEmpty(Data_Generic.genericArray(Data_Generic.genericInt))(Data_Generic.genericInt))))("group'")(Data_Array["group'"](Data_Ord.ordInt))();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveBoolean))("null")(Data_Array["null"])();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveInt))("length")(Data_Array.length)();
          doc(Sparkle.interactiveFunction(Sparkle.flammableInt)(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveArray(Data_Generic.genericInt))))("cons")(Data_Array.cons)();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveFunction(Sparkle.flammableInt)(Sparkle.interactiveArray(Data_Generic.genericInt))))("snoc")(Data_Array.snoc)();
          doc(Sparkle.interactiveFunction(Sparkle.flammableInt)(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveArray(Data_Generic.genericInt))))("insert")(Data_Array.insert(Data_Ord.ordInt))();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveMaybe(Data_Generic.genericInt)))("head")(Data_Array.head)();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveMaybe(Data_Generic.genericInt)))("last")(Data_Array.last)();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveMaybe(Data_Generic.genericArray(Data_Generic.genericInt))))("tail")(Data_Array.tail)();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveMaybe(Data_Generic.genericArray(Data_Generic.genericInt))))("init")(Data_Array.init)();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableString))(Sparkle.interactiveFunction(Sparkle.flammableInt)(Sparkle.interactiveMaybe(Data_Generic.genericString))))("index")(Data_Array.index)();
          doc(Sparkle.interactiveFunction(Sparkle.flammableString)(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableString))(Sparkle.interactiveMaybe(Data_Generic.genericInt))))("elemIndex")(Data_Array.elemIndex(Data_Eq.eqString))();
          doc(Sparkle.interactiveFunction(Sparkle.flammableString)(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableString))(Sparkle.interactiveMaybe(Data_Generic.genericInt))))("elemLastIndex")(Data_Array.elemLastIndex(Data_Eq.eqString))();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveMaybe(Data_Generic.genericInt)))("findIndex")(Data_Array.findIndex(Data_Int.even))();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveMaybe(Data_Generic.genericInt)))("findLastIndex")(Data_Array.findLastIndex(Data_Int.even))();
          doc(Sparkle.interactiveFunction(Sparkle.flammableInt)(Sparkle.interactiveFunction(Sparkle.flammableString)(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableString))(Sparkle.interactiveMaybe(Data_Generic.genericArray(Data_Generic.genericString))))))("insertAt")(Data_Array.insertAt)();
          doc(Sparkle.interactiveFunction(Sparkle.flammableInt)(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableString))(Sparkle.interactiveMaybe(Data_Generic.genericArray(Data_Generic.genericString)))))("deleteAt")(Data_Array.deleteAt)();
          doc(Sparkle.interactiveFunction(Sparkle.flammableInt)(Sparkle.interactiveFunction(Sparkle.flammableString)(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableString))(Sparkle.interactiveMaybe(Data_Generic.genericArray(Data_Generic.genericString))))))("updateAt")(Data_Array.updateAt)();
          doc(Sparkle.interactiveFunction(Sparkle.flammableInt)(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveMaybe(Data_Generic.genericArray(Data_Generic.genericInt)))))("modifyAt")(function (i) {
              return Data_Array.modifyAt(i)(function (v) {
                  return v * 10 | 0;
              });
          })();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveArray(Data_Generic.genericInt)))("reverse")(Data_Array.reverse)();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableArray(Sparkle.flammableInt)))(Sparkle.interactiveArray(Data_Generic.genericInt)))("concat")(Data_Array.concat)();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveArray(Data_Generic.genericInt)))("concatMap")(Data_Array.concatMap(function (n) {
              return [ n, n + 1 | 0 ];
          }))();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveArray(Data_Generic.genericInt)))("filter")(Data_Array.filter(Data_Int.even))();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveRecordInstance()(Sparkle.prettyPrintRowListCons(Data_Generic.genericArray(Data_Generic.genericInt))(Sparkle.prettyPrintRowListCons(Data_Generic.genericArray(Data_Generic.genericInt))(Sparkle.prettyPrintRowListNil)(Type_Row.rowLacks()()()(Type_Row.rowLacking))()()(new Data_Symbol.IsSymbol(function () {
              return "yes";
          })))(Type_Row.rowLacks()()()(Type_Row.rowLacking))()()(new Data_Symbol.IsSymbol(function () {
              return "no";
          })))))("partition")(Data_Array.partition(Data_Int.even))();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableMaybe(Sparkle.flammableInt)))(Sparkle.interactiveArray(Data_Generic.genericInt)))("catMaybes")(Data_Array.catMaybes)();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveArray(Data_Generic.genericInt)))("sort")(Data_Array.sort(Data_Ord.ordInt))();
          doc(Sparkle.interactiveFunction(Sparkle.flammableInt)(Sparkle.interactiveFunction(Sparkle.flammableInt)(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableString))(Sparkle.interactiveArray(Data_Generic.genericString)))))("slice")(Data_Array.slice)();
          doc(Sparkle.interactiveFunction(Sparkle.flammableInt)(Sparkle.interactiveArray(Data_Generic.genericInt)))("singleton")(Data_Array.singleton)();
          doc(Sparkle.interactiveFunction(Sparkle.flammableInt)(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveArray(Data_Generic.genericInt))))("take")(Data_Array.take)();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveArray(Data_Generic.genericInt)))("takeWhile")(Data_Array.takeWhile(Data_Int.even))();
          doc(Sparkle.interactiveFunction(Sparkle.flammableInt)(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveArray(Data_Generic.genericInt))))("drop")(Data_Array.drop)();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveArray(Data_Generic.genericInt)))("dropWhile")(Data_Array.dropWhile(Data_Int.even))();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveRecordInstance()(Sparkle.prettyPrintRowListCons(Data_Generic.genericArray(Data_Generic.genericInt))(Sparkle.prettyPrintRowListCons(Data_Generic.genericArray(Data_Generic.genericInt))(Sparkle.prettyPrintRowListNil)(Type_Row.rowLacks()()()(Type_Row.rowLacking))()()(new Data_Symbol.IsSymbol(function () {
              return "rest";
          })))(Type_Row.rowLacks()()()(Type_Row.rowLacking))()()(new Data_Symbol.IsSymbol(function () {
              return "init";
          })))))("span")(Data_Array.span(Data_Int.even))();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveArray(Data_Generic.genericInt)))("nub")(Data_Array.nub(Data_Eq.eqInt))();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveArray(Data_Generic.genericInt))))("union")(Data_Array.union(Data_Eq.eqInt))();
          doc(Sparkle.interactiveFunction(Sparkle.flammableInt)(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveArray(Data_Generic.genericInt))))("delete")(Data_Array["delete"](Data_Eq.eqInt))();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveArray(Data_Generic.genericInt))))("(\\\\)")(Data_Array.difference(Data_Eq.eqInt))();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveArray(Data_Generic.genericInt))))("intersect")(Data_Array.intersect(Data_Eq.eqInt))();
          doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableString))(Sparkle.interactiveArray(Data_Generic.genericTuple(Data_Generic.genericInt)(Data_Generic.genericString)))))("zip")(Data_Array.zip)();
          return doc(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableTuple(Sparkle.flammableInt)(Sparkle.flammableString)))(Sparkle.interactiveTuple(Data_Generic.genericArray(Data_Generic.genericInt))(Data_Generic.genericArray(Data_Generic.genericString))))("unzip")(Data_Array.unzip)();
      };
  });
  exports["main"] = main;
